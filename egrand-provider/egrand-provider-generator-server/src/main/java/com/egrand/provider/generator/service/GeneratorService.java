package com.egrand.provider.generator.service;
...
public class GeneratorService {
    ...
    public static void execute(GenerateConfig generateConfig) {
        ...
        // mapper 父类
        strategy.setSuperMapperClass("com.egrand.core.mybatis.base.mapper.SuperMapper");
        // 实体父类
        strategy.setSuperEntityClass("com.egrand.core.mybatis.base.entity.AbstractEntity");
        // 接口父类
        strategy.setSuperServiceClass("com.egrand.core.mybatis.base.service.IBaseService");
        // 接口实现类父类
        strategy.setSuperServiceImplClass("com.egrand.core.mybatis.base.service.impl.BaseServiceImpl");
        // 需要生成的表
